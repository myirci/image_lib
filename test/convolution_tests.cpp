...
void generate_edge_detected_images()
{
    ...
    JpegAdapter::export_to_jpeg("petit_prince_grayscale_dy.jpg", 70, img1__);
    ...
    JpegAdapter::export_to_jpeg("petit_prince_dy.jpg", 70, img2__);
}
...
void generate_gradient_images()
{
    ...
    JpegAdapter::export_to_jpeg("petit_prince_grayscale_grad.jpg", 70, img2);
    
    auto img3 = apply_linear_filter(img1, kernelx);
    Algorithm::contrast(img3, 2.5);
    Algorithm::invert(img3);
    JpegAdapter::export_to_jpeg("petit_prince_grayscale_grad_dx.jpg", 70, img3);
    auto img4 = apply_linear_filter(img1, kernely);
    Algorithm::contrast(img4, 2.5);
    Algorithm::invert(img4);
    JpegAdapter::export_to_jpeg("petit_prince_grayscale_grad_dy.jpg", 70, img4);
}
...
void generate_blocks_in_grayscale() 
{
    ...
    Image<unsigned char> img1(600, 600, ColorSpace::GrayScale, 1, 100);
    
    
    color_mono<unsigned char> inside_box_color(127);
    ...
    Image<unsigned char> img2(600, 600, ColorSpace::GrayScale, 1, 154);
...
void generate_blocks_in_rgb()
{
    ...
    Image<unsigned char> img1(600, 600, ColorSpace::RGB, 3);
    color_rgb<unsigned char> img1_color(100,0,0);
    set_color(img1, img1_color);
    color_rgb<unsigned char> inside_box_color(127,0,0);
    width_third = img1.num_rows()/3;
    top = width_third;
    bottom = img1.num_rows() - width_third;
    left = width_third;
    ...
    Image<unsigned char> img2(600, 600, ColorSpace::RGB, 3);
    color_rgb<unsigned char> img2_color(154,0,0);
...
void generate_bars_in_grayscale() 
{
    Image<unsigned char> img(600, 600, ColorSpace::GrayScale, 1);
    color_mono<unsigned char> first_color(0);
...
void generate_bars_in_rgb() 
{
    Image<unsigned char> img(600, 600, ColorSpace::RGB, 3);
    color_rgb<unsigned char> first_color(50,100,150);
...
void generate_grayscale_from_rgb_image() 
{
    Image<unsigned char> img1_rgb("img1_rgb.jpg");
    Image<unsigned char> img1_grayscale(184, 274, ColorSpace::GrayScale, 1);
    convert_rgb_to_grayscale(img1_rgb, img1_grayscale);
    img1_grayscale.save_jpeg("img1_grayscale.jpg", 90);

    Image<unsigned char> img2_rgb("img2_rgb.jpg");
    Image<unsigned char> img2_grayscale(275, 183, ColorSpace::GrayScale, 1);
    convert_rgb_to_grayscale(img2_rgb, img2_grayscale);
    img2_grayscale.save_jpeg("img2_grayscale.jpg", 90);

    Image<unsigned char> img3_rgb("earth_rgb.jpg");
    Image<unsigned char> img3_grayscale(2048, 2048, ColorSpace::GrayScale, 1);
...
void generate_shrinked_image_from_grayscale() 
{
    Image<unsigned char> img1_grayscale("img1_grayscale.jpg");
    Image<unsigned char> img1_grayscale_shrink;
    shrink(img1_grayscale, 2, img1_grayscale_shrink);
    img1_grayscale_shrink.save_jpeg("img1_grayscale_shrink.jpg", 80);

    Image<unsigned char> img2_grayscale("img2_grayscale.jpg");
    Image<unsigned char> img2_grayscale_shrink;
    shrink(img2_grayscale, 2, img2_grayscale_shrink);
    img2_grayscale_shrink.save_jpeg("img2_grayscale_shrink.jpg", 80);

    Image<unsigned char> earth_grayscale("earth_grayscale.jpg");
    Image<unsigned char> earth_grayscale_shrink;
...
void test_apply_filter()
{
    Image<unsigned char> img(6, 5, ColorSpace::GrayScale, 1);
    img(0)(0,0) = 7;
    img(0)(0,1) = 4;
    img(0)(0,2) = 10;
    img(0)(0,3) = 0;
...
void generate_gradient_images()
{
    ...
    Image<unsigned char> img1("im.jpg");
    Image<unsigned char> img1_;
